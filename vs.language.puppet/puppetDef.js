...
define(["require", "exports"], function (require, exports) {
    /*
    Puppet language definition (NEEDS UPDATED, simply a copy of rubyDef.js for the most part)
    ...
    Puppet expressions again (and span multiple lines). Moreover, expanded
